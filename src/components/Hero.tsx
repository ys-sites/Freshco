      ...
      <div className="relative z-10 w-full md:w-[65%]">
        ...
        >
          ...
          <div className="flex flex-wrap gap-2 mt-auto">
            <div className="bg-white/10 px-2.5 md:px-3 py-1.5 rounded-full text-[11px] md:text-[12px] text-white font-medium border border-white/10">✓ {isFr ? 'Viande Certifiée Halal' : 'Halal Certified Meat'}</div>
            <div className="bg-white/10 px-2.5 md:px-3 py-1.5 rounded-full text-[11px] md:text-[12px] text-white font-medium border border-white/10">✓ {isFr ? 'Arrivages Quotidiens' : 'Fresh Daily Arrivals'}</div>
            <div className="bg-white/10 px-2.5 md:px-3 py-1.5 rounded-full text-[11px] md:text-[12px] text-white font-medium border border-white/10">✓ {isFr ? 'Épices Importées' : 'Imported Spices'}</div>
          </div>
        </motion.div>
      </div>
    </section>
