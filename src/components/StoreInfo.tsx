  ...
  return (
    <section className="bg-theme-card border border-theme-border rounded-[20px] p-4 md:p-4 shadow-sleek w-full">
      ...
      <div className="flex flex-col gap-2 md:gap-3">
        ...
        >
          <motion.div
            ...
            whileHover={{ scale: 1.2, rotate: -8, transition: SPRING }}
          >
      ...
      <motion.a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="w-full mt-3 md:mt-4 bg-transparent border-2 border-theme-border text-theme-text font-bold py-2 md:py-2 px-4 rounded-[10px] text-[12px] md:text-[13px] hover:border-theme-primary hover:text-theme-primary transition-[border-color,color] flex justify-center items-center gap-2"
